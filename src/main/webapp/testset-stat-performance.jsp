    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Stat - Performance</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1">
                            <span class="label label-info" id="id_slider_display">Exp: 4800</span>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Performance</h3>
                        </div>
        ...
        $(document).ready(function(){
            last_data = [
              {"elapsed": "2014 wk24", "value": 3600, "expected": 4200},
              {"elapsed": "2014 wk25", "value": 3800, "expected": 4200},
              {"elapsed": "2014 wk26", "value": 4200, "expected": 4200},
              {"elapsed": "2014 wk27", "value": 5600, "expected": 4200},
              {"elapsed": "2014 wk28", "value": 2800, "expected": 4200},
              {"elapsed": "2014 wk29", "value": 3600, "expected": 4200},
              {"elapsed": "2014 wk30", "value": 5400, "expected": 4200},
              {"elapsed": "2014 wk31", "value": 3800, "expected": 4200},
              {"elapsed": "2014 wk32", "value": 3920, "expected": 4200},
              {"elapsed": "2014 wk33", "value": 8200, "expected": 4200}
            ];
